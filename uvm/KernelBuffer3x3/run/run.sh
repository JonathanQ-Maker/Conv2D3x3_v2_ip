...
SOURCES_SV=" \
    ./src/KernelBuffer3x3.sv \
    ./uvm/KernelBuffer3x3/seq_pkg.sv \
    ./uvm/KernelBuffer3x3/ref_model_pkg.sv \
    ./uvm/KernelBuffer3x3/env_pkg.sv \
    ./uvm/KernelBuffer3x3/rand_test_pkg.sv \
    ./uvm/KernelBuffer3x3/load_test_pkg.sv \
    ./uvm/KernelBuffer3x3/top.sv \
"
...
xsim tb_snapshot --tclbatch ./uvm/KernelBuffer3x3/run/xsim_cfg.tcl --testplusarg "{ UVM_TESTNAME="$UVM_TESTNAME" }"

if [ "$1" == "waves" ]; then
    echo "### OPENING WAVES ###"
    xsim --gui tb_snapshot.wdb -view ./uvm/KernelBuffer3x3/run/tb_snapshot.wcfg
fi