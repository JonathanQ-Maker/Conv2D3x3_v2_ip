...
SOURCES_SV=" \
    ...
    ./uvm/Conv2D3x3/seq_pkg.sv \
    ./uvm/Conv2D3x3/ref_model_pkg.sv \
    ./uvm/Conv2D3x3/env_pkg.sv \
    ./uvm/Conv2D3x3/rand_test_pkg.sv \
    ./uvm/Conv2D3x3/load_test_pkg.sv \
    ./uvm/Conv2D3x3/top.sv \
"
...
xsim tb_snapshot --tclbatch ./uvm/Conv2D3x3/run/xsim_cfg.tcl --testplusarg "{ UVM_TESTNAME="$UVM_TESTNAME" }" -sv_seed "3742897"

if [ "$1" == "waves" ]; then
    echo "### OPENING WAVES ###"
    xsim --gui tb_snapshot.wdb -view ./uvm/Conv2D3x3/run/tb_snapshot.wcfg
fi